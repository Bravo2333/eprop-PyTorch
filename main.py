...
def main():
    ...
    parser.add_argument('--batch-size', type=int, default=100, help='Batch size for training (limited by the available GPU memory)')
    parser.add_argument('--test-batch-size', type=int, default=100, help='Batch size for testing (limited by the available GPU memory)')
